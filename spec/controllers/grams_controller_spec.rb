...
RSpec.describe GramsController, type: :controller do
  ...
  describe "grams#update" do
    it "should not allow a user that did not create the gram to update the gram" do
      gram = FactoryBot.create(:gram)
      user = FactoryBot.create(:user)
      sign_in user
    ...
    it "should not allow an unauthenticated user to update a gram" do
  ...
  describe "grams#edit action" do
    it "should not allow a user that did not create the gram to edit the gram" do 
      gram = FactoryBot.create(:gram)
      user = FactoryBot.create(:user)
      sign_in user
